...
export default function Splash() {
  ...
  return (
    <button onClick={enter} style={cssText("flex:1;min-height:0;width:100%;border:none;cursor:pointer;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:0;padding:0;background:radial-gradient(120% 70% at 50% 36%,#F0E7D6 0%,#E4D8C2 60%,#DCCFB6 100%);")}>
